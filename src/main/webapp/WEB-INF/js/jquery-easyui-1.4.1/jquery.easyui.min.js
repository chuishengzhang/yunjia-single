...
if(item){
item.width=_57a;
var rule=this.getRule(item.manager);
if(rule){
...
var _68e=_687(_68c,_68d.manager!=undefined?_68d.manager:_68d.id);
...
view.insertRow.call(view,_6a9,_6aa.manager,_6aa.row);
_6ab.push(_6aa.row);
...
var tr=opts.finder.getTr(_6c9,(_6ca.manager!=undefined?_6ca.manager:_6ca.id),_6ca.type);
if(!tr.length){
return;
}
...
return jq.each(function(){
var opts=$.data(this,"datagrid").options;
opts.view.updateRow.call(opts.view,this,_71b.manager,_71b.row);
});
