...
if(_18){
_18.width=_17;
var _19=this.getRule(_18.manager);
if(_19){
_19.style["width"]=_17;
}
}
...
var _154=_14d(_152,_153.manager!=undefined?_153.manager:_153.id);
...
view.insertRow.call(view,_16f,_170.manager,_170.row);
_171.push(_170.row);
...
var tr=opts.finder.getTr(_18f,(_190.manager!=undefined?_190.manager:_190.id),_190.type);
if(!tr.length){
return;
}
...
return jq.each(function(){
var opts=$.data(this,"datagrid").options;
opts.view.updateRow.call(opts.view,this,_1e1.manager,_1e1.row);
});
